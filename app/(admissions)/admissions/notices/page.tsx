...
export default function AdmissionsNoticesPage() {
  ...
  return (
    <>
      <div>
        ...
        <p className="text-[13px] text-neutral-500 mt-0.5">{published.length} published notices · read-only, managed by Super Admin</p>
      </div>
