...
import type { AttendanceReportsData } from '@/lib/attendance/reports-data'

export default function AttendanceReportsContent({ monthTrend, classComparison, classTotals }: AttendanceReportsData) {
    ...
    <>
      ...
      <div className="bg-white rounded-2xl border border-neutral-200 shadow-1 overflow-hidden">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 divide-y xl:divide-y-0 xl:divide-x divide-neutral-100">
          {GRADES.map((g) => {
            const rate = classComparison[g]
            const total = classTotals[g]
            return (
