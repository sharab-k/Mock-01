  ...
  if (!isValid) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <Link href={basePath} className="mt-4 text-[13px] font-medium text-ink-600 hover:text-ink-800">← Back to Marks</Link>
      </div>
    )
  }
      ...
      <div className="bg-white rounded-2xl border border-neutral-200 shadow-1 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-100 gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Link href={`${basePath}/enter`} className="text-[12px] text-ink-600 hover:text-ink-800 no-underline font-medium ml-1">Enter →</Link>
          </div>
        </div>
        ...
        {totalEntries === 0 ? (
          <div className="flex flex-col items-center py-16 text-center px-8">
            ...
            <Link href={`${basePath}/enter`} className="inline-flex items-center gap-2 px-4 py-2.5 bg-ink-700 text-white text-[13px] font-semibold rounded-xl hover:bg-ink-800 transition-colors no-underline">
