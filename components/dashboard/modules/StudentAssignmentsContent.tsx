...
// Stays mocked — explicitly out of scope per BACKEND-IMPLEMENTATION-PLAN.md
// (no assignments/assignment_submissions tables).
...
export default function StudentAssignmentsContent({ studentId }: { studentId: string }) {
