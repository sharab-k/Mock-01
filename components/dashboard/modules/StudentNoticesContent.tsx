...
export default function StudentNoticesContent({ studentId, notices }: { studentId: string; notices: Notice[] }) {
  ...
  return (
    <>
      <div>
        ...
        <p className="text-[13px] text-neutral-500 mt-0.5">{notices.length} notices for you</p>
      </div>
